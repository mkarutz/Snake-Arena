...
public final class ServerGoodbye extends Table {
  ...
  public static ServerGoodbye getRootAsServerGoodbye(ByteBuffer _bb, ServerGoodbye obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
