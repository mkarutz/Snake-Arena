...
public final class TickAck extends Table {
  ...
  public static TickAck getRootAsTickAck(ByteBuffer _bb, TickAck obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public TickAck __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
