...
public final class ServerWorldState extends Table {
  ...
  public in.slyther.flatbuffers.NetworkObjectState objectStates(int j) { return objectStates(new in.slyther.flatbuffers.NetworkObjectState(), j); }
  public in.slyther.flatbuffers.NetworkObjectState objectStates(in.slyther.flatbuffers.NetworkObjectState obj, int j) { int o = __offset(6); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
